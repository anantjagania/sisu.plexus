...
public final class PlexusXmlBeanConverter implements PlexusBeanConverter {
    ...
    public static PlexusXmlBeanConverter create(final Injector injector) {
        PlexusXmlBeanConverter converter = new PlexusXmlBeanConverter();
        converter.typeConverterBindings = injector.getTypeConverterBindings();
    ...
    private Map<String, Object> parseMap(final MXParser parser, final TypeLiteral<?> toType)
      throws Exception {
        @SuppressWarnings("unchecked") final Map<String, Object> map = newImplementation(parser, HashMap.class);
        while (parser.nextTag() == XmlPullParser.START_TAG) {
    ...
    private Collection<Object> parseCollection(final MXParser parser, final TypeLiteral<?> toType)
      throws Exception {
        @SuppressWarnings("unchecked") final Collection<Object> collection = newImplementation(parser, ArrayList.class);
        while (parser.nextTag() == XmlPullParser.START_TAG) {
