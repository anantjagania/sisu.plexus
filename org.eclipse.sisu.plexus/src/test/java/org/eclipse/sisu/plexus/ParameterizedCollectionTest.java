...
public class ParameterizedCollectionTest {
    ...
    public void testParameterizedMap()
      throws Exception {
        ...
        Assertions.assertEquals(expectedMap, mapHolder.map);
    }
    ...
    public void testParameterizedList()
      throws Exception {
        ...
        Assertions.assertEquals(expectedList, listHolder.list);
    }
    ...
    public void testParameterizedArray()
      throws Exception {
        ...
        Assertions.assertEquals(2, arrayHolder.array.length);
        Assertions.assertEquals(expectedArray[0], arrayHolder.array[0]);
        Assertions.assertEquals(expectedArray[1], arrayHolder.array[1]);
    }
