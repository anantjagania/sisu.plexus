...
public class PlexusBeanMetadataTest {
    ...
    public void testExtraMetadata() {
        Assertions.assertEquals("REQUIREMENT", bean.getExtraMetadata());
        Assertions.assertEquals("CONFIGURATION", injector.getInstance(DefaultBean2.class).extraMetadata);
        Assertions.assertSame(bean, injector.getInstance(Key.get(Bean.class, Names.named("2"))));
    }
