...
public class ArrayConstantTest {
    ...
    public void testCustomArray() {
        Assertions.assertTrue(Arrays.equals(new Object[] { true, URI.create("file:temp"), 8.1f }, custom));
    }

    @Test
    public void testStringArray() {
        Assertions.assertTrue(Arrays.equals(new String[] { "1", "2", "3" }, text));
    }

    @Test
    public void testPrimitiveArray() {
        Assertions.assertTrue(Arrays.equals(new int[] { 4, 5, 6 }, numbers));
    }

    @Test
    @SuppressWarnings("boxing")
    public void testMultiArrays() {
        Assertions.assertTrue(Arrays.deepEquals(new Integer[][] { { 1, 2 }, { 3, 4 }, { 5, 6 } }, multi1));
        Assertions.assertTrue(Arrays.deepEquals(new double[][] { { 1, 2 }, { 3, 4 }, { 5, 6 } }, multi2));
    }
}
