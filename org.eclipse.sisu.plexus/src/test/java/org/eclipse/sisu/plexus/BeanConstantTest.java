...
public class BeanConstantTest {
    ...
    public void testEmptyBeanConversion() {
        Assertions.assertEquals(EmptyBean.class, getBean("EmptyBean", Object.class).getClass());
    }
    ...
    public void testPeerClassLoader1() {
        ...
        try {
            ...
            Assertions.assertEquals(EmptyBean.class, getBean("EmptyBean", EmptyBean.class).getClass());
        } finally {
    ...
    public void testBeanWithPropertiesConversion() {
        ...
        Assertions.assertEquals(4.2f, beanWithProperties.value, 0f);
        Assertions.assertEquals(beanWithProperties.text.length(), 0);
    }
    ...
    public void testStringXMLConversion() {
        ...
        Assertions.assertEquals(configurator.convert(TypeLiteral.get(String.class), "<one><two/></one>").length(), 0);
    }
    ...
    public void testSimpleFileBean() {
        Assertions.assertEquals("readme.txt", injector.getInstance(Key.get(File.class, Names.named("README"))).getName());
    }

    @Test
    public void testSimpleUrlBean() {
        Assertions.assertEquals("www.sonatype.org",
    ...
    public void testNonBean() {
        ...
        Assertions.assertEquals(Calendar.NOVEMBER, calendar.get(Calendar.MONTH));
        Assertions.assertEquals(2009, calendar.get(Calendar.YEAR));
    }
    ...
    public void testConfigurator() {
        ...
        Assertions.assertEquals(4.2f, value, 0);
    }
