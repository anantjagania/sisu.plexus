...
public class PlexusBeanLocatorTest {
    ...
    public void testInjectorOrdering() {
        ...
        final Iterable<? extends Entry<String, Bean>> roles =
          DefaultPlexusBeanLocator.create(locator, null, null).locate(TypeLiteral.get(Bean.class));
        ...
        i = roles.iterator();
        Assertions.assertEquals("M1", i.next().getKey());
        Assertions.assertEquals("N1", i.next().getKey());
        Assertions.assertEquals("M3", i.next().getKey());
        Assertions.assertEquals("N3", i.next().getKey());
        Assertions.assertEquals("A", i.next().getKey());
        Assertions.assertEquals("-", i.next().getKey());
        Assertions.assertEquals("Z", i.next().getKey());
    ...
    public void testRoleHintLookup() {
        ...
        final Iterable<? extends Entry<String, Bean>> roles =
          DefaultPlexusBeanLocator.create(locator, null, null).locate(TypeLiteral.get(Bean.class), "A", "M1", "N3", "-", "!",
            "-", "M3", "N1", "Z");
        ...
        Assertions.assertEquals("!", pling.getKey());
        Assertions.assertEquals("-", i.next().getKey());
        Assertions.assertEquals("M3", i.next().getKey());
        Assertions.assertEquals("N1", i.next().getKey());
        Assertions.assertEquals("Z", i.next().getKey());
        ...
        Assertions.assertEquals("!=<missing>", pling.toString());
        ...
        Assertions.assertEquals("A", i.next().getKey());
        m1 = i.next();
        Assertions.assertEquals("M1", m1.getKey());
        Assertions.assertEquals("N3", i.next().getKey());
        dash1 = i.next();
        Assertions.assertEquals("-", dash1.getKey());
        Assertions.assertEquals("!", i.next().getKey());
        dash2 = i.next();
        Assertions.assertEquals("-", dash2.getKey());
        m3 = i.next();
        Assertions.assertEquals("M3", m3.getKey());
        Assertions.assertEquals("N1", i.next().getKey());
        Assertions.assertEquals("Z", i.next().getKey());
        Assertions.assertFalse(i.hasNext());

        Assertions.assertNull(m1.getValue());
        Assertions.assertSame(dash1.getValue(), dash2.getValue());
        Assertions.assertNull(m3.getValue());
        ...
        Assertions.assertEquals("M1=" + m1.getValue(), m1.toString());
        Assertions.assertEquals(BeanImpl.class, m1.getValue().getClass());
        Assertions.assertSame(m1.getValue(), m1.getValue());
        Assertions.assertSame(dash1.getValue(), dash2.getValue());
        Assertions.assertNull(m3.getValue());
    }
    ...
    public void testInjectorVisibility()
      throws NoSuchRealmException {
        ...
        publishInjector(locator, Guice.createInjector(new Module() {
            public void configure(final Binder binder) {
                try {
                    binder.withSource(world.getRealm("B").createChildRealm("B1")).bind(Bean.class).annotatedWith(Names.named("B1"))
                      .to(BeanImpl.class);
        ...
        publishInjector(locator, Guice.createInjector(new Module() {
            public void configure(final Binder binder) {
                try {
                    binder.withSource(world.getRealm("B").createChildRealm("B2")).bind(Bean.class).annotatedWith(Names.named("B2"))
                      .to(BeanImpl.class);
                } catch (final ClassWorldException e) {
                    throw new RuntimeException(e);
                }
        ...
        publishInjector(locator, Guice.createInjector(new Module() {
            public void configure(final Binder binder) {
                try {
                    binder.withSource(world.getRealm("B").createChildRealm("B3")).bind(Bean.class).annotatedWith(Names.named("B3"))
                      .to(BeanImpl.class);
                } catch (final ClassWorldException e) {
                    throw new RuntimeException(e);
                }
        ...
        publishInjector(locator, Guice.createInjector(new Module() {
            public void configure(final Binder binder) {
                try {
                    binder.withSource(world.getRealm("B2").createChildRealm("B2B")).bind(Bean.class)
                      .annotatedWith(Names.named("B2B")).to(BeanImpl.class);
                } catch (final ClassWorldException e) {
                    throw new RuntimeException(e);
                }
            }
        ...
        final Iterable<? extends Entry<String, Bean>> beans =
          DefaultPlexusBeanLocator.create(locator, new RealmManager(locator),
        ...
        Assertions.assertTrue(i.hasNext());
        Assertions.assertEquals("!", i.next().getKey());
        Assertions.assertEquals("C", i.next().getKey());
        Assertions.assertEquals("B", i.next().getKey());
        Assertions.assertEquals("A", i.next().getKey());
        Assertions.assertFalse(i.hasNext());
        ...
        Assertions.assertTrue(i.hasNext());
        Assertions.assertEquals("!", i.next().getKey());
        Assertions.assertEquals("B3", i.next().getKey());
        Assertions.assertEquals("B2", i.next().getKey());
        Assertions.assertEquals("B1", i.next().getKey());
        Assertions.assertEquals("C", i.next().getKey());
        Assertions.assertEquals("B", i.next().getKey());
        Assertions.assertEquals("A", i.next().getKey());
        Assertions.assertFalse(i.hasNext());
        ...
        Assertions.assertTrue(i.hasNext());
        Assertions.assertEquals("!", i.next().getKey());
        Assertions.assertEquals("B2B", i.next().getKey());
        Assertions.assertEquals("B3", i.next().getKey());
        Assertions.assertEquals("B2", i.next().getKey());
        Assertions.assertEquals("B1", i.next().getKey());
        Assertions.assertEquals("C", i.next().getKey());
